...
public class GreatCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("Total grade Of A = " + gradeOfA.size());
        System.out.println("Total grade Of B = " + gradeOfB.size());
        System.out.println("Total grade Of C = " + gradeOfC.size());
        System.out.println("Total grade Of D = " + gradeOfD.size());
        System.out.println("Total grade Of F= " + gradeOfF.size());
